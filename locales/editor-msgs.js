...
export default {
  "en": {
    "gui.alerts.lostPeripheralConnection": "Stemstar lost connection to {extensionName}.",
    ...
    "gui.unsupportedBrowser.notRecommended": "We are very sorry, but it looks like you are using a browser version that Stemstar does not support. We recommend updating to the latest version of a supported browser such as Google Chrome, Mozilla Firefox, Microsoft Edge, or Apple Safari.",
    "gui.unsupportedBrowser.description": "We are very sorry, but Stemstar does not support this browser. We recommend updating to the latest version of a supported browser such as Google Chrome, Mozilla Firefox, Microsoft Edge, or Apple Safari.",
    ...
    "gui.connection.unavailable.installscratchlink": "Make sure you have Stemstar Link installed and running",
    ...
    "gui.crashMessage.description": "We are so sorry, but it looks like Stemstar has crashed. This bug has been automatically reported to the Stemstar Team. Please refresh your page to try again.",
    ...
    "gui.telemetryOptIn.label": "Report statistics to improve Stemstar",
    "gui.telemetryOptIn.body1": "The Stemstar Team is always looking to better understand how Stemstar is used around the world. To help support this effort, you can allow Stemstar to automatically send usage information to the Stemstar Team.",
    ...
    "gui.telemetryOptIn.optInText": "Share my usage data with the Stemstar Team",
    "gui.telemetryOptIn.optInTooltip": "Enable telemetry",
    "gui.telemetryOptIn.optOutText": "Do not share my usage data with the Stemstar Team",
    ...
    "gui.updateModel.alreadyLatestTips": "Stemstar is already the latest version.",
    ...
    "gui.webglModal.description": "Unfortunately it looks like your browser or computer {webGlLink}. This technology is needed for Stemstar to run.",
    ...
    "gui.device.scratchstar.description": "Scratch star",
    ...
    "gui.gui.defaultProjectTitle": "Stemstar Project",
  ...
  "ru": {
    "gui.alerts.lostPeripheralConnection": "Stemstar потерял соединение с {extensionName}.",
    ...
    "gui.updateModel.alreadyLatestTips": "Установлена самая последняя версия Stemstar",
  ...
  "zh-cn": {
    "gui.alerts.lostPeripheralConnection": "Stemstar与{extensionName}的连接已断开。",
    ...
    "gui.unsupportedBrowser.notRecommended": "我们十分抱歉，Stemstar不支持您正在使用的浏览器，我们建议您升级到我们所支持的浏览器的最新版本，例如Chrome、火狐、Edge或者Safari。",
    "gui.unsupportedBrowser.description": "我们十分抱歉，Stemstar并不支持您当前使用的浏览器，我们建议您升级到我们所支持的浏览器的最新版，例如Chrome、火狐、Edge或者Safari。",
    ...
    "gui.connection.unavailable.installscratchlink": "确保Stemstar Link已安装并正在运行",
    ...
    "gui.crashMessage.description": "很抱歉，Stemstar出故障了。这个问题已经自动报告给Stemstar开发团队。请刷新页面再试试。",
    ...
    "gui.telemetryOptIn.label": "统计使用情况并发送给Stemstar",
    "gui.telemetryOptIn.body1": "允许Stemstar自动发送使用情况信息给Stemstar团队，帮助我们了解Stemstar在全世界的使用情况。",
    ...
    "gui.telemetryOptIn.optInText": "与 Stemstar 团队分享我的使用数据",
    "gui.telemetryOptIn.optInTooltip": "发送统计信息",
    "gui.telemetryOptIn.optOutText": "不要与 Stemstar 团队分享我的使用数据",
    ...
    "gui.updateModel.alreadyLatestTips": "Stemstar 已经是最新的版本了。",
    ...
    "gui.webglModal.description": "非常遗憾，你的电脑或浏览器{webGlLink}。Stemstar需要该技术才能运行。",
    ...
    "gui.gui.defaultProjectTitle": "Stemstar作品",
  ...
  "zh-tw": {
    "gui.alerts.lostPeripheralConnection": "Stemstar 與 {extensionName} 的連線中斷。",
    ...
    "gui.unsupportedBrowser.notRecommended": "很抱歉，這個版本的瀏覽器無法支援 Stemstar。建議你改用其它的，像是 Google Chrome、Mozilla Firefox、Microsoft Edge、Apple Safari。",
    "gui.unsupportedBrowser.description": "很抱歉，這個瀏覽器無法支援 Stemstar。建議你改用其它的，像是 Google Chrome、Mozilla Firefox、Microsoft Edge、Apple Safari。",
    "gui.unsupportedBrowser.back": "返回",
    ...
    "gui.connection.unavailable.installscratchlink": "確定你已經安裝並執行 Stemstar Link",
    ...
    "gui.crashMessage.description": "很抱歉，看起來 Stemstar 崩潰了，錯誤已自動回報給 Stemstar 團隊，請重新整理你的頁面，再試一次吧！",
    ...
    "gui.stageSelector.stage": "舞台",
    "gui.stageSelector.backdrops": "背景",
    "gui.telemetryOptIn.label": "回報統計數據以協助改善 Stemstar",
    "gui.telemetryOptIn.body1": "Stemstar 團隊希望能深入瞭解 Stemstar 在世界各地的使用情況。如果可以的話，希望你能允許 Stemstar 將你的使用情形紀錄下來並發送給 Stemstar 團隊。",
    ...
    "gui.telemetryOptIn.optInText": "分享我的使用資料給 Stemstar 團隊",
    "gui.telemetryOptIn.optInTooltip": "啟用 Telemetry",
    "gui.telemetryOptIn.optOutText": "不分享我的使用資料給 Stemstar 團隊",
    ...
    "gui.updateModel.alreadyLatestTips": "Stemstar 已經是最新的版本了。",
    ...
    "gui.webglModal.description": "似乎你的瀏覽器或裝置 {webGlLink}，這是讓 Stemstar 運作的必要技術。",
    ...
    "gui.gui.defaultProjectTitle": "Stemstar專案",
